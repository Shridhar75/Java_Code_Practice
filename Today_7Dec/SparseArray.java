package Today_7Dec;
/*
This Java program is to Implement Sparse array.
In computer science, a sparse array is an array in which most of the
elements have the same value (known as the default value—usually 0 or null).
...
Here is the source code of the Java program to implement sparse array.
The Java program is successfully compiled and run on a Linux system. The program output is also shown below.
 */
class List
{
    private int index;
